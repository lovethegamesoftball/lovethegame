    ...
    <section class="meet">
      ...
      <div class="columns">
        ...
        <div class="column text-about">
          <p>
            I have over five years of softball coaching experience in San Diego
            working with athletes ages 7-17. My pitching coach, Bill Corbett,
            instilled this motto in me: "Always love the game". As a coach, I
            seek to foster a love for softball in my clients and help them have
            fun while improving each day.
          </p>
          <br />
          ...
          <p>
            At Carleton College in Minnesota, I pitched and played 2B while
            earning a Geology degree. As one of the team captains my senior
            year, I helped lead our team to break the Carleton single-season win
            record. I am now a Ph.D. Candidate in Climate Science at UCSD. It
            has been a joy to coach in my hometown and work with the next
...
.meet {
  padding: 24px;
  border-radius: 12px;
  border: 3px double rgb(15, 139, 141);
}
